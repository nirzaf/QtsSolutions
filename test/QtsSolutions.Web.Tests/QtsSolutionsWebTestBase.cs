...
{
    public abstract class QtsSolutionsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static QtsSolutionsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(QtsSolutionsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<QtsSolutionsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<QtsSolutionsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<QtsSolutionsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<QtsSolutionsDbContext, Task<T>> func)
        {
            T result;
